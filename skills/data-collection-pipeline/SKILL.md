...
2. Use Crawlee Python as the default acquisition runtime when a reusable crawler/download layer is needed. Start blocked handling in observation mode with `retry_on_blocked=False`.
