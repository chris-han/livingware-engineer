...
**Placeholders:**
- `[MODEL]` — optional override when the session model is unsuitable
- `[BRIEF_FILE]` — existing task requirements or optional brief file
- `[FINDINGS]` — the Critical/Important findings and spec gaps from the
  previous review, copied verbatim, one per bullet
- `[REPORT_FILE]` — inspectable implementer results or optional report file
- `[FIX_BASE_SHA]` — the head the previous review saw
- `[HEAD_SHA]` — current commit
- `[DIFF_FILE]` — supplied fix diff, exact commit range, or optional packaged file
