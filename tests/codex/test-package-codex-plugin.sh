...
assert_equals "$manifest_summary" "livingware-engineer	$expected_version	skills	$source_hooks" "archive manifest preserves Livingware source identity and hooks"
